...
#            statement2=["show me the offers for Iphone", "Show me the offers for Mobile Phone", "I would like to buy Iphone", "I would like to buy mobile phone" ]
            ...
            if "good bye" in statement or "ok bye" in statement or "stop" in statement:
                ...
                url = "https://www.newurl.com/deals"
                wb.open(url)
                speak("Here is the various offers I found on newurl Shop")

            elif "black friday" in statement:
            #elif there_exists(["black friday"]) or "newurl" in statement:
                url = 'https://www.newurl.com/black-friday'
                wb.open(url)
                speak("Here is the black friday deals I found on newurl Shop")

            elif "free cellphone" in statement:
            #elif there_exists(["free cellphones", "free smartphones", "free cell phones", "free smart phones"]) or "newurl" in statement:
                url = 'https://www.newurl.com/shop/online/free-cell-phones'
                wb.open(url)
                speak("Here is the free smartphone deal i found on newurl Shop")

            elif "preowned" in statement:
            #elif there_exists(["certified smartphones", "pre owned smartphones"]) or "newurl" in statement:
                url = 'https://www.newurl.com/shop/online/certified-pre-owned'
                wb.open(url)
                speak("Here is the certified smartphone deal i found on newurl Shop")
            ...
            #elif there_exists(["certified smartphones", "pre owned smartphones"]) or "newurl" in statement:
                url = 'https://www.newurl.com/deals/prepaid'
                wb.open(url)
                speak("Here is the prepaid plan details i found on newurl Shop")

            elif "payment" in statement:
            #elif there_exists(["mobile bill", "payments", "billings"]) or "newurl" in statement:
                url = 'https://www.newurl.com/support/billing-and-payments'
                wb.open(url)
                speak("Please follow the instructions to understand your bills and payments")

            elif there_exists(["shop", "buy"]) or "newurl" in statement:
                search_term = statement.split("locate")[-1]
                url = 'https://www.newurl.com/onesearch/search?q=' + search_term + "&src=wireless"
                wb.get().open(url)
                speak("Here is what I found for " + search_term + "on newurl shop")
                time.sleep(4) 

            elif "byod" in statement:
            #elif there_exists(["mobile bill", "payments", "billings"]) or "newurl" in statement:
                url = 'https://www.newurl.com/bring-your-own-device/'
                wb.open(url)
                speak("Here is the details found on bring your own device on newurl shop")
            ...
            #elif there_exists(["mobile bill", "payments", "billings"]) or "newurl" in statement:
                url = 'https://www.newurl.com/5g-home-internet/'
                wb.open(url)
                speak("Here is the details found on 5g Home Internet on newurl shop")     
 
            elif "fios" in statement:
            #elif there_exists(["mobile bill", "payments", "billings"]) or "newurl" in statement:
                url = 'https://www.newurl.com/deals/fios/'
                wb.open(url)
                speak("Here is the details found on fiber optic service on newurl shop")  

            elif there_exists(["locate"]) or "newurl" in statement:
                search_term = statement.split("locate")[-1]
